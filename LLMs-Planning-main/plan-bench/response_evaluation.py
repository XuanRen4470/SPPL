...
if __name__=="__main__":
    ...
    parser.add_argument('--modified_path', type=str, default=None, help='Verbose')
    #config
    ...
    if task in eval_plan_dict:
        ...
        try:
            ...
            raise ValueError("Invalid task name")
        response_evaluator.evaluate_state(task_name, modified_path = modified_path)
    elif task in eval_verification_dict:
        try:
            task_name = eval_verification_dict[task]
        except:
            raise ValueError("Invalid task name")
        response_evaluator.evaluate_verification(task_name, modified_path = modified_path)
