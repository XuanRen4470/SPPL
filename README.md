...
The initial predictions are saved in SPPL/Mix_Score_Ranking_Calculation/Mix_Score_record/initial_prediction_record_modified/
...
* **`synthetic_data_generator.py`** — create synthetic data for experiments.
  Although synthetic generation is *conceptually first*, the datasets used in our comparisons are **already generated** under the dataset folder.
