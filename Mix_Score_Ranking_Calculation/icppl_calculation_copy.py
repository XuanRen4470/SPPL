...
"""
        ...
        icppl_dict_path = f"/gpfs/users/a1796450/ACL_2024/SPPL/Mix_Score_Ranking_Calculation/delete_later/record_book/{n_train}_icppl_{model_name}_{train_task_name}_icppl_dict_{suffix}.json"
        ...
        for initial_index, last_index in index_range_list:
            ...
            with open(f"/gpfs/users/a1796450/ACL_2024/SPPL/Mix_Score_Ranking_Calculation/delete_later/{n_train}_icppl_{model_name}_{train_task_name}_{initial_index}_{last_index}_{suffix}.json", 'w') as f:
