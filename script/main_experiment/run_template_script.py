...
# task_name_list: specify the tasks you want to train]
task_name_list = ["gsm8k", 'math_algebra', 'ecqa', 'boolq', "squad", 'winogrande', 'piqa', 'mmlu', 'agieval', 'mmlu_pro', 'mmlu_moral_scenarios', 'hellaswag', 'arc_challenge', 'drop', 'math_intermediate_algebra', 'math_geometry']

# task_name_list = ['plan_bench_generation', 'plan_bench_generalization', 'plan_bench_optimality', 'plan_bench_verification', 'plan_bench_execution', 'plan_bench_reuse', 'plan_bench_replaning']

file_suffix = "dec_8" # it is just a suffix after the file name. you do not need to care about file_suffix 
model_type_list = ["mistral", 'qwen', "llama_3_instruct"] # this define which target model you wish to train and evaluate

# train_method_list: specify the teacher model you want to evaluate
#   - If you want to evaluate the ground truth, use: train_method_list = ["groundtruth"]
#   - If you want to evaluate a teacher model such as GPT-4o, use: train_method_list = ["gpt4"]
train_method_list = ["groundtruth", "gpt4", "mini_gpt4", "claude"] 

sft_epoch = "20" # how many training epochs you wish to train?
# sft_epoch = "40"

seed_num_list = ['0', '1', '2'] # define seed number

sft_lr_list = ['2e-5', '2e-4'] # learning rate
# sft_lr_list = ['2e-5']
# sft_lr_list = ['2e-4']

# variation_suffix_list_non_gpt4/variation_suffix_list_gpt4_gt_non_cot/variation_suffix_list_gpt4_gt_cot  defines the meta prompt. if you don't wish to use the meta prompt(answer directly), you can set them to none
variation_suffix_list_non_gpt4 = ["none"]
variation_suffix_list_gpt4_gt_non_cot = ['none', "variation_gpt4_style_in_context_examples", "variation_openai_human_written_examples", 'variation_step_by_step']
variation_suffix_list_gpt4_gt_cot = ['none', "variation_gpt4_style_in_context_examples", "variation_openai_human_written_examples", 'variation_step_by_step', 'variation_rewrite_groundtruth_in_own_words']

training_data_size = ['100', '1000'] #are you training on 100 data or 10000 data?
...
# for n_train in ['3000']:
# for n_train in ['6000']:
for n_train in [training_data_size]:
